...
摄像头识别手势，挥手造出**成群发光的爱心**追着指尖飞；聚散变阵成 🌹玫瑰 / 💞双心 / 🏹丘比特之箭 / 🌌漫天星河。霓虹流光、粒子拖尾、心跳光晕、柔光的梦幻浪漫画风。
...
**键盘**（也可无摄像头玩）：`1` 玫瑰 · `2` 双心 · `3` 之箭 · `4` 星河 · `5` 归聚 · `空格` 追随 · `H` 隐藏说明 · `V` 摄像头残影 · `M` 心跳音效

## 退路

没有摄像头 / 拒绝授权 / 无网，会自动切到**鼠标 + 键盘模式**：移动鼠标即指尖，按数字键变阵。
...
- **阵型**：心形 / 玫瑰线(rhodonea) / 箭 / 对数螺旋星系的参数方程，粒子弹簧吸附目标点做聚散变换
